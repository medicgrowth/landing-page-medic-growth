        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="flex flex-col gap-5">
            {profiles.map((profile, i) => (
              <motion.div
                ...
                whileHover={{ x: 4 }}
                className="group flex gap-5 p-6 rounded-2xl border border-[#E8E6E0] hover:border-[#C9A96E]/30 hover:bg-[#F7F6F2] transition-all duration-300 cursor-default"
              >
          ...
          <div>
            <motion.p
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5 }}
              className="text-[#9CA3AF] text-sm font-medium uppercase tracking-widest mb-8"
            >
            ...
            <motion.div
              ...
              className="mt-10 p-6 bg-[#0D2625] rounded-2xl"
            >
