      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-16">
          ...
          <motion.p
            ...
            className="text-[#6B7280] text-base leading-relaxed max-w-sm lg:text-right"
          >
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {items.map((item, i) => (
            <motion.div
              ...
              whileHover={{ y: -3 }}
              className="group bg-white rounded-2xl p-7 border border-[#E8E6E0] hover:border-[#0D2625]/10 hover:shadow-lg transition-all duration-300 cursor-default"
            >
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5, delay: items.length * 0.09 }}
            className="bg-[#0D2625] rounded-2xl p-7 flex flex-col justify-between"
          >
            <div>
